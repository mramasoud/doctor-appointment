...
public class PatientTest {
    ...
    @Autowired
    public PatientTest(PatientController patientController, PatientService patientService, PatientRepository patientRepository, AppointmentRepository appointmentRepository, DoctorRepository doctorRepository) {
