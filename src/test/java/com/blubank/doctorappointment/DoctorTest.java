...
public class DoctorTest {
    ...
    @Autowired
    public DoctorTest(DoctorController doctorController, PatientRepository patientRepository, AppointmentRepository appointmentRepository, DoctorRepository doctorRepository, CacheService cacheService) {
